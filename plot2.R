##### Exploratory Data Analysis Week 1 Assignment 1 plot2 ######
...
# Create and Save Line plot for "global_active_power" as function of "date_time" to active working directory
png(file.path(filepath,filename="plot2.png"), width=480, height=480)
