##### Exploratory Data Analysis Week 1 Assignment 1 plot4 ######
...
# Create and Safe four plots with layout in four quadrants
png(file.path(filepath,filename="plot4.png"), width=480, height=480)
...
# Create plot for "sub_metering_1 & 2 & 3" as a function of "date_time"
...
with(epc_eval_data,legend("topright", col=c("black", "red", "blue"), lty=1, lwd=2, legend=c("Sub_metering_1","Sub_metering_2","Sub_metering_3"), bty="n"))

# Create plot for "global_reactive_power" as function of "date_time"
with(epc_eval_data, plot(global_reactive_power~date_time, type="l", col="black", ylab="Global_reactive_power", xlab="datetime"))
