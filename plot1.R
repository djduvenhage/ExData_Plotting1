##### Exploratory Data Analysis Week 1 Assignment 1 plot1 ######
...
# Create and Save Histogram Plot for "global_active_power" to active working directory
png(file.path(filepath,filename="plot1.png"), width=480, height=480)
